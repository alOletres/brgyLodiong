...
(function (EValidFileExtension) {
    ...
    EValidFileExtension["WORDX"] = "docx";
    EValidFileExtension["WORDS"] = "docs";
    EValidFileExtension["EXCEL"] = "xls";
    EValidFileExtension["EXCELX"] = "xlsx";
...
(function (EValidMimeType) {
    ...
    EValidMimeType["MS_WORD"] = "application/msword";
    EValidMimeType["MS_WORD_APPLICATION"] = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
