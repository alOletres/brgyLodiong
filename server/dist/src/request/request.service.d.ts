...
export declare class RequestService {
    ...
    constructor(prisma: PrismaService, twilioService: TwilioService, residentService: ResidentsService, notificationService: NotificationService, emailService: EmailService);
