...
declare const FindAllResidentsDto_base: import("@nestjs/common").Type<Omit<ResidentsEntity, "Notifications" | "createdAt" | "Auth" | "Requests" | "requestsId" | "EventNotifications"> & Pick<AuthEntity, "status" | "role">>;
